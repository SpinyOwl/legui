...
import org.liquidengine.legui.backend.opengl.LeguiBackendOpengl;
import org.liquidengine.legui.component.Frame;
import org.liquidengine.legui.context.LeguiConfig;
import org.liquidengine.legui.context.LeguiContext;
import org.liquidengine.legui.processor.LeguiSystemEventProcessor;
import org.liquidengine.legui.renderer.LeguiRenderer;
...
public class Example {
    ...
    public static void main(String[] args) throws IOException {
        ...
        LeguiConfig.loadBackend(LeguiBackendOpengl.getInstance());

        long window = initialize();
        ...
        LeguiSystemEventProcessor leguiEventProcessor = null; // new LeguiEventProcessor();
        LeguiContext              context             = null; // new LeguiContext(frame, leguiEventProcessor);
...
//            glViewport(0, 0, windowSize.x, windowSize.y);
    ...
    private static void destroy(long window) {
