package org.liquidengine.legui.listener.system.checkbox;
 ...
 */
public class CheckBoxSystemMouseClickEventListener implements SystemEventListener<CheckBox, SystemMouseClickEvent> {
    @Override
