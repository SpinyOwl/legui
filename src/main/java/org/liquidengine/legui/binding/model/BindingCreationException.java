...
public class BindingCreationException extends RuntimeException {
     ...
     * to {@link #initCause}.
     */
    public BindingCreationException() {
    }
     ...
     * @since 1.4
     */
    public BindingCreationException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public BindingCreationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
