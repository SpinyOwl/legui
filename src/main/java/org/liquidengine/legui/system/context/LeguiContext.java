...
public class LeguiContext {
    ...
    public LeguiContext(long glfwWindow, Frame frame, LeguiEventProcessor eventProcessor) {
    ...
    public LeguiEventProcessor getEventProcessor() {
        return eventProcessor;
    }

    public void setEventProcessor(LeguiEventProcessor eventProcessor) {
        this.eventProcessor = eventProcessor;
    }
