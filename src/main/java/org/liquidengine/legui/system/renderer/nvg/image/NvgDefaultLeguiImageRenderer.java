...
import org.liquidengine.legui.system.renderer.nvg.NvgLeguiImageRenderer;
 ...
 */
public class NvgDefaultLeguiImageRenderer<I extends Image> extends NvgLeguiImageRenderer<I> {
     ...
     */
    @Override
    protected void renderImage(I image, Vector2fc position, Vector2fc size, Map<String, Object> properties, LeguiContext context, long nanovg) {
        ...
        renderTextLineToBounds(nanovg, x, y, w, h, h / 3, FontRegistry.DEFAULT, ColorConstants.red(), IMAGE, HorizontalAlign.CENTER, VerticalAlign.MIDDLE, true);
