...
/**
 * LeguiRenderer for Slider components.
 */
public class NvgSliderRendererLegui<T extends Slider> extends NvgLeguiComponentRenderer<T> {
     ...
     */
    @Override
    public void renderComponent(T slider, LeguiContext leguiContext, long context) {
