 ...
 */
public class NvgContainerRendererLegui extends NvgLeguiComponentRenderer<Container> {

    @Override
    protected void renderComponent(Container component, LeguiContext context, long nanovg) {
        ...
        for (Component child : all) {
            LeguiRendererProvider.getInstance().
