...
import org.liquidengine.legui.system.renderer.nvg.NvgLeguiBorderRenderer;
 ...
 */
public class NvgSimpleLineLeguiBorderRenderer extends NvgLeguiBorderRenderer<SimpleLineBorder> {
    @Override
    protected void renderBorder(SimpleLineBorder border, Component component, LeguiContext context, long nanovg) {
        if (border.isEnabled()) {
