 ...
 */
public class NvgTooltipRendererLegui extends NvgLeguiComponentRenderer<Tooltip> {
    private NVGColor colorA = NVGColor.create();


    @Override
    public void renderComponent(Tooltip tooltip, LeguiContext leguiContext, long context) {
