 ...
 */
public class NvgDefaultLeguiComponentRenderer extends NvgLeguiComponentRenderer {

    @Override
    protected void renderComponent(Component component, LeguiContext context, long nanovg) {
