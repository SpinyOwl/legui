 ...
 */
public class NvgTextInputRendererLegui extends NvgLeguiComponentRenderer<TextInput> {
    ...
    @Override
    public void renderComponent(TextInput textInput, LeguiContext leguiContext, long context) {
    ...
    private void renderText(LeguiContext leguiContext, long context, TextInput gui, Vector2f size, Vector4f rect, Vector4f bc) {
