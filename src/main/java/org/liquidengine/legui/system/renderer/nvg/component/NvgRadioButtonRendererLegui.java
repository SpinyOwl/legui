 ...
 */
public class NvgRadioButtonRendererLegui extends NvgLeguiComponentRenderer<RadioButton> {
    private NVGColor colorA = NVGColor.create();

    @Override
    public void renderComponent(RadioButton radioButton, LeguiContext context, long nanovg) {
