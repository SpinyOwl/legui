 ...
 */
public class NvgDefaultLeguiBorderRenderer extends NvgLeguiBorderRenderer {
    @Override
    protected void renderBorder(Border border, Component component, LeguiContext context, long nanovg) {
