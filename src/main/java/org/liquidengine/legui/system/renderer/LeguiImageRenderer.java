 ...
 * Image renderer.
 */
public abstract class LeguiImageRenderer<I extends Image> {
     ...
     */
    public void render(I image, Vector2fc position, Vector2fc size, Map<String, Object> properties, LeguiContext context) {
     ...
     * @param context    context.
     */
    public abstract void renderImage(I image, Vector2fc position, Vector2fc size, Map<String, Object> properties, LeguiContext context);
