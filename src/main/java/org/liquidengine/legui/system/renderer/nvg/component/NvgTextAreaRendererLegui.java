 ...
 */
public class NvgTextAreaRendererLegui extends NvgLeguiComponentRenderer<TextArea> {
    ...
    @Override
    public void renderComponent(TextArea component, LeguiContext leguiContext, long context) {
    ...
    private void renderText(LeguiContext leguiContext, long context, TextArea gui, Vector2f size, Vector4f rect, Vector4f bc) {
