 ...
 */
public class NvgPasswordInputRendererLegui extends NvgLeguiComponentRenderer<PasswordInput> {
    ...
    @Override
    public void renderComponent(PasswordInput passwordInput, LeguiContext leguiContext, long context) {
     ...
     */
    private void renderText(LeguiContext leguiContext, long context, PasswordInput gui, Vector2f size, Vector4f rect, Vector4f bc) {
        ...
        try {
            ...
            // render text
            renderTextLineToBounds(context, textBounds[4] - poffset, textBounds[5], textBounds[6], textBounds[7], fontSize, font, textColor, maskedText, HorizontalAlign.LEFT, VerticalAlign.MIDDLE, false);
