 ...
 */
public class NvgCheckBoxRendererLegui extends NvgLeguiComponentRenderer<CheckBox> {
    private NVGColor colorA = NVGColor.create();


    @Override
    public void renderComponent(CheckBox checkBox, LeguiContext context, long nanovg) {
