 ...
 */
public class LeguiCursorEnterEvent<T extends Component> extends LeguiEvent<T> {
    private final boolean  entered;
    private final Vector2f delta;
    private final Vector2f cursorPosition;

    public LeguiCursorEnterEvent(T component, LeguiContext context, boolean entered, Vector2f delta, Vector2f cursorPosition) {
