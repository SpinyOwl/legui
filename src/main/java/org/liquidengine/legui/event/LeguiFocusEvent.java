 ...
 */
public class LeguiFocusEvent<T extends Component> extends LeguiEvent<T> {
     ...
     */
    public LeguiFocusEvent(T component, LeguiContext context, Component nextFocus, boolean focused) {
