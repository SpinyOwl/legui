...
public enum LeguiExceptions {
    SERIALIZE_EXCEPTION("Can't serialize your tooltipComponent"),
    DESERIALIZE_EXCEPTION("Can't deserialize your tooltipComponent"),
    SERIALIZER_IS_NOT_EXIST("Can't find serializer for tooltipComponent type: '%s'"),
    DESERIALIZER_IS_NOT_EXIST("Can't find deserializer for tooltipComponent type: '%s'"),
