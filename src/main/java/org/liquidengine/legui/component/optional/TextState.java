...
public class TextState implements Serializable {
    protected String          font            = Theme.DEFAULT_THEME.font();
    protected float           fontSize        = Theme.DEFAULT_THEME.fontSize();
    protected StringBuffer    text            = new StringBuffer();
    protected HorizontalAlign horizontalAlign = Theme.DEFAULT_THEME.horizontalAlign();
    protected VerticalAlign   verticalAlign   = Theme.DEFAULT_THEME.verticalAlign();
    protected Vector4f        textColor       = Theme.DEFAULT_THEME.fontColor();
    protected Vector4f        highlightColor  = Theme.DEFAULT_THEME.highlightColor();
    protected Vector4f        padding         = Theme.DEFAULT_THEME.textPadding();
