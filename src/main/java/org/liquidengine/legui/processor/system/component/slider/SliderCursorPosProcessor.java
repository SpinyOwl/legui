 ...
 */
public class SliderCursorPosProcessor implements LeguiComponentEventProcessor<Slider, CursorPosEvent> {
    @Override
    public void process(Slider slider, CursorPosEvent event, LeguiContext leguiContext) {
