 ...
 */
public class SliderScrollProcessor implements LeguiComponentEventProcessor<Slider, ScrollEvent> {
    @Override
    public void process(Slider gui, ScrollEvent event, LeguiContext leguiContext) {
        float maxValue = 100f;
        float minValue = 0f;
