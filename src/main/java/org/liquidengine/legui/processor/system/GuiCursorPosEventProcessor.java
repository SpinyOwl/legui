 ...
 */
public class GuiCursorPosEventProcessor extends LeguiSystemEventProcessor<CursorPosEvent> {

    public GuiCursorPosEventProcessor(LeguiContext context) {
        super(context);
    }

    @Override
    public void processEvent(CursorPosEvent event, Component mainGui, Component target) {
