 ...
 */
public class TextInputMouseClickProcessor implements LeguiComponentEventProcessor<TextInput, MouseClickEvent> {
    @Override
    public void process(TextInput gui, MouseClickEvent event, LeguiContext leguiContext) {
